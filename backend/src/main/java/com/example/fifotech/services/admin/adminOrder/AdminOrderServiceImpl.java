...
import com.example.fifotech.entity.Order;
import com.example.fifotech.enums.OrderStatus;
...
public class AdminOrderServiceImpl implements AdminOrderService {
    ...
    public List<OrderDto> getAllPlaceOrders() {
        ...
        List<Order> orderList = orderRepository.findAllByOrderStatusIn(List.of(OrderStatus.Placed, OrderStatus.Placed, OrderStatus.Shipped, OrderStatus.Delivered));
